    ...
    constructor() {
        ...
        this.execute = async (M) => {
            ...
            if (i < 1 || i > party.length) {
                return void M.reply(`❌ *Invalid slot!* Your party has *${party.length}* Pokémon.\n\nPick a slot between *1* and *${party.length}*.`);
            }
            ...
            return void await this.client.sendMessage(M.from, {
                text: `✅ *${this.client.utils.capitalize(pokemon.name)}* transferred to your PC!\n\n` +
