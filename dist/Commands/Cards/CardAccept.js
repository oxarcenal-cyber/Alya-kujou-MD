...
let CardAcceptCommand = class CardAcceptCommand extends Structures_1.BaseCommand {
    constructor() {
        super(...arguments);
...
CardAcceptCommand = __decorate([
    (0, Structures_1.Command)('cardaccept', {
...
exports.default = CardAcceptCommand;
