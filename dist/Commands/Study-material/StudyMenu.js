...
let StudyMenuCommand = class StudyMenuCommand extends Structures_1.BaseCommand {
    constructor() {
        super(...arguments);
...
StudyMenuCommand = __decorate([
    (0, Structures_1.Command)('study', {
...
exports.default = StudyMenuCommand;
