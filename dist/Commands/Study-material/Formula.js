...
let FormulaCommand = class FormulaCommand extends Structures_1.BaseCommand {
    constructor() {
        super(...arguments);
        this.execute = async (M, { context }) => {
            ...
            if (!topic)
                return void M.reply(`📐 *FORMULA LOOKUP* 📐\n` +
                    `${'━'.repeat(28)}\n\n` +
            ...
            const result = await (0, StudyAI_1.studyAI)(`Give me the formula for: ${topic}`, SYSTEM, 300);
            if (!result)
...
FormulaCommand = __decorate([
    (0, Structures_1.Command)('formula', {
...
exports.default = FormulaCommand;
