...
let default_1 = class extends Structures_1.BaseCommand {
    constructor() {
        ...
        this.execute = async (M) => {
            ...
            return void (await M.reply(await this.client.utils.gifToMp4(await new canvas_chan_1.Triggered(buffer).build()), 'video', true, 'video/mp4'));
        };
    }
};
default_1 = __decorate([
    (0, Structures_1.Command)('triggered', {
