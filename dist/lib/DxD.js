...
exports.getDxDLine = exports.getRandomGreeting = exports.findDxDCharacter = exports.getDxDCharacterCount = exports.getDxDLineCount = exports.DXD_GREETINGS = exports.DXD_CHARACTERS = void 0;
exports.DXD_CHARACTERS = [
    {
        name: 'Issei Hyodo',
        aliases: ['issei', 'ise'],
        lines: [
...
const ALL_LINES_COUNT = exports.DXD_CHARACTERS.reduce((sum, c) => sum + c.lines.length, 0);
const getDxDLineCount = () => ALL_LINES_COUNT;
exports.getDxDLineCount = getDxDLineCount;
const getDxDCharacterCount = () => exports.DXD_CHARACTERS.length;
exports.getDxDCharacterCount = getDxDCharacterCount;
const findDxDCharacter = (query) => {
    const q = query.trim().toLowerCase();
    if (!q)
        return undefined;
    return exports.DXD_CHARACTERS.find((c) => c.name.toLowerCase() === q || c.aliases.some((a) => a.toLowerCase() === q));
};
exports.findDxDCharacter = findDxDCharacter;
const getRandomGreeting = (kind) => {
    const lines = exports.DXD_GREETINGS[kind];
    return lines[Math.floor(Math.random() * lines.length)];
};
exports.getRandomGreeting = getRandomGreeting;
const getDxDLine = (character) => {
    let chara;
    if (character && character.trim()) {
        chara = (0, exports.findDxDCharacter)(character);
        if (!chara)
            return null;
    }
    else {
        chara = exports.DXD_CHARACTERS[Math.floor(Math.random() * exports.DXD_CHARACTERS.length)];
    }
    const line = chara.lines[Math.floor(Math.random() * chara.lines.length)];
    return { character: chara.name, line };
};
exports.getDxDLine = getDxDLine;
