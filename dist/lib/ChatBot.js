...
const AI_TIMEOUT_MS = 8000; // 8 second max — agar AI hang kare toh fallback mile
const askRias = async (message, userId, persona = 'rias') => {
    ...
    try {
        const completion = await openai.chat.completions.create({
            model: config_1.default.GROQ_API_KEY ? 'llama-3.1-8b-instant' : 'gpt-4o-mini',
            messages: [
