...
exports.moderation = {
    en: {
        ...
        // ── langlist ─────────────────────────────────────────────────────
        langlist_header: '🌐 *LANGUAGE PREVIEW*\n' +
            '━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n' +
        ...
        // ── clearwarn ─────────────────────────────────────────────────────
        clearwarn_done: '✅ *WARNINGS CLEARED* ✅\n' +
            '─────────────────────────\n\n' +
            '👤 *User:* @{user}\n' +
        ...
        // ── close ─────────────────────────────────────────────────────────
        close_admin_only: '❌ *Only admins can use this!*\n\n📢 *How to use:* `{prefix}close`',
        close_already: '⚠️ *Group is already closed!*\n\n📢 To open: `{prefix}open`',
        close_done: '🔒 *GROUP CLOSED!*\n\nOnly admins can send messages now.\n\n📢 *How to use:* `{prefix}close`\n_To open: `{prefix}open`_',
        // ── demote ────────────────────────────────────────────────────────
        demote_admin_only: '❌ *Only admins can use this!*\n\n📢 *How to use:* `{prefix}demote @user`',
        demote_tag_or_quote: '❌ Tag or quote someone!\n\n📢 *How to use:* `{prefix}demote @admin`',
        ...
        // ── dxdchat ───────────────────────────────────────────────────────
        dxdchat_admin_only: '❌ *Only admins can use this!*\n\n📢 *How to use:* `{prefix}dxdchat on/off`',
        dxdchat_status: '🐉 *HIGH SCHOOL DxD CHAT*\n' +
            '─────────────────────────\n\n' +
            '📌 *Status:* {status}\n' +
            '👥 *Characters:* {chars}\n' +
        ...
        modgive_set_no_amount: '❌ *Provide an amount!*\n\n📢 Usage: `{prefix}modgive @user set <amount> [bank]`',
        modgive_no_amount: '❌ *No amount found!*\n\n' +
            '📢 *Usage:*\n' +
        ...
        // ── open ──────────────────────────────────────────────────────────
        open_admin_only: '❌ *Only admins can use this!*\n\n📢 *How to use:* `{prefix}open`',
        open_already: '⚠️ *Group is already open!*\n\n📢 To close: `{prefix}close`',
        open_done: '🔓 *GROUP OPEN!*\n\nAll members can send messages now.\n\n📢 *How to use:* `{prefix}open`\n_To close: `{prefix}close`_',
        // ── promote ───────────────────────────────────────────────────────
        promote_admin_only: '❌ *Only admins can use this!*\n\n📢 *How to use:* `{prefix}promote @user`',
        promote_tag_or_quote: '❌ Tag or quote someone!\n\n📢 *How to use:* `{prefix}promote @user`',
        ...
        // ── remove ────────────────────────────────────────────────────────
        remove_admin_only: '❌ *Only admins can use this!*\n\n📢 *How to use:* `{prefix}remove @user`',
        remove_tag_or_quote: '❌ Tag or quote someone!\n\n📢 *How to use:* `{prefix}remove @user`',
        ...
        setrules_admin_only: '❌ *Only admins can set rules!*\n\n📢 *How to use:* `{prefix}setrules <rules>`',
        setrules_no_content: '📝 *SET GROUP RULES*\n\n' +
            'Set the rules for the group!\n\n' +
            '📢 *How to use:*\n' +
            '`{prefix}setrules\n1. No spam\n2. Respect everyone\n3. No NSFW\n4. Links not allowed`\n\n' +
            '_To view rules: `{prefix}rules`_',
        setrules_done: '✅ *RULES SET!* ✅\n' +
            '─────────────────────────\n\n' +
            '📜 *Rules:*\n{rules}\n\n' +
            '─────────────────────────\n' +
        ...
        warnings_none: '✅ @{user} has no warnings in this group!\n\n📢 *How to use:* `{prefix}warnings @user`',
        // ── welcome ───────────────────────────────────────────────────────
        welcome_status: '┌───□ *WELCOME FEATURE* □\n' +
            '├◇ 📌 *Status:* {status}\n' +
            '├◇ 👥 *Group:* {group}\n' +
            '└──────────────────□\n\n' +
            '💡 *Usage:*\n' +
    ...
    hi: {
        ...
        // ── langlist ─────────────────────────────────────────────────────
        langlist_header: '🌐 *LANGUAGE PREVIEW / भाषा पूर्वावलोकन*\n' +
            '━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n' +
            '📌 *Current Language:* {current}\n\n' +
        ...
        clearwarn_done: '✅ *WARNINGS CLEARED* ✅\n' +
            ...
            '📢 *How to use:* `{prefix}clearwarn @user`',
        // ── close ─────────────────────────────────────────────────────────
        close_admin_only: '❌ *Sirf admins use kar sakte hain!*\n\n📢 *How to use:* `{prefix}close`',
        close_already: '⚠️ *Group pehle se closed hai!*\n\n📢 Open karne ke liye: `{prefix}open`',
        close_done: '🔒 *GROUP CLOSED!*\n\nAb sirf admins message kar sakte hain.\n\n📢 *How to use:* `{prefix}close`\n_Open karne ke liye: `{prefix}open`_',
        // ── demote ────────────────────────────────────────────────────────
        demote_admin_only: '❌ *Sirf admins use kar sakte hain!*\n\n📢 *How to use:* `{prefix}demote @user`',
        demote_tag_or_quote: '❌ Kisi ko tag ya quote karo!\n\n📢 *How to use:* `{prefix}demote @admin`',
        ...
        // ── dxdchat ───────────────────────────────────────────────────────
        dxdchat_admin_only: '❌ *Sirf admins use kar sakte hain!*\n\n📢 *How to use:* `{prefix}dxdchat on/off`',
        dxdchat_status: '🐉 *HIGH SCHOOL DxD CHAT*\n' +
            '─────────────────────────\n\n' +
            '📌 *Status:* {status}\n' +
            '👥 *Characters:* {chars}\n' +
        ...
        dxdchat_invalid: '❌ *on* ya *off* likho!\n\n📢 *How to use:*\n  `{prefix}dxdchat on`\n  `{prefix}dxdchat off`',
        ...
        // ── dxdgreet ──────────────────────────────────────────────────────
        dxdgreet_admin_only: '❌ *Sirf admins use kar sakte hain!*\n\n📢 *How to use:* `{prefix}dxdgreet on/off`',
        dxdgreet_status: '🌙 *DxD AUTO GREETINGS*\n' +
            '─────────────────────────\n\n' +
            '📌 *Status:* {status}\n\n' +
            '⏰ *Kab bhejta hai:*\n' +
        ...
        dxdgreet_invalid: '❌ *on* ya *off* likho!\n\n📢 *How to use:*\n  `{prefix}dxdgreet on`\n  `{prefix}dxdgreet off`',
        ...
        // ── gchatbot ──────────────────────────────────────────────────────
        gchatbot_admin_only: '❌ *Sirf admins use kar sakte hain!*\n\n📢 *How to use:* `{prefix}gchatbot on/off`',
        gchatbot_not_configured: '❌ *Chatbot configure nahi hai!*\n\nBot owner se contact karo.\n\n📢 *How to use:* `{prefix}gchatbot on/off`',
        gchatbot_status: '🤖 *GROUP CHATBOT*\n' +
            '─────────────────────────\n\n' +
            '📌 *Status:* {status}\n\n' +
            '─────────────────────────\n' +
        ...
        gchatbot_invalid: '❌ *on* ya *off* likho!\n\n📢 *How to use:*\n  `{prefix}gchatbot on`\n  `{prefix}gchatbot off`',
        ...
        // ── modgive ───────────────────────────────────────────────────────
        modgive_who: '❓ *Kise gold dena hai?*\n\n' +
            ...
            '• `{prefix}modgive @user set 99999`\n' +
            '• `{prefix}modgive @user reset`',
        modgive_set_no_amount: '❌ *Amount likho!*\n\n📢 Usage: `{prefix}modgive @user set <amount> [bank]`',
        modgive_no_amount: '❌ *Amount nahi mila!*\n\n' +
            '📢 *Usage:*\n' +
        ...
        // ── open ──────────────────────────────────────────────────────────
        open_admin_only: '❌ *Sirf admins use kar sakte hain!*\n\n📢 *How to use:* `{prefix}open`',
        open_already: '⚠️ *Group pehle se open hai!*\n\n📢 Close karne ke liye: `{prefix}close`',
        open_done: '🔓 *GROUP OPEN!*\n\nAb sab members message kar sakte hain.\n\n📢 *How to use:* `{prefix}open`\n_Band karne ke liye: `{prefix}close`_',
        // ── promote ───────────────────────────────────────────────────────
        promote_admin_only: '❌ *Sirf admins use kar sakte hain!*\n\n📢 *How to use:* `{prefix}promote @user`',
        promote_tag_or_quote: '❌ Kisi ko tag ya quote karo!\n\n📢 *How to use:* `{prefix}promote @user`',
        promote_skip_already_admin: '⚠️ Skipped @{user} — pehle se admin hai',
        promote_success: '✅ Promoted @{user} to admin',
        promote_fail: '❌ @{user} promote nahi hua',
        // ── remove ────────────────────────────────────────────────────────
        remove_admin_only: '❌ *Sirf admins use kar sakte hain!*\n\n📢 *How to use:* `{prefix}remove @user`',
        remove_tag_or_quote: '❌ Kisi ko tag ya quote karo!\n\n📢 *How to use:* `{prefix}remove @user`',
        ...
        setrules_admin_only: '❌ *Sirf admins rules set kar sakte hain!*\n\n📢 *How to use:* `{prefix}setrules <rules>`',
        setrules_no_content: '📝 *SET GROUP RULES*\n\n' +
        ...
        tagall_admin_only: '❌ *Sirf admins use kar sakte hain!*\n\n📢 *How to use:* `{prefix}tagall [message]`',
        // ── warn ──────────────────────────────────────────────────────────
        warn_group_only: '❌ Ye command sirf groups mein use hoti hai!',
        warn_admin_only: '❌ *Sirf admins use kar sakte hain!*\n\n📢 *How to use:* `{prefix}warn @user [reason]`',
        warn_tag_or_quote: '❌ Kisi ko tag ya quote karo!\n\n📢 *How to use:* `{prefix}warn @user spam kar raha tha`',
        ...
        warnings_none: '✅ @{user} ke koi warnings nahi hain is group mein!\n\n📢 *How to use:* `{prefix}warnings @user`',
        // ── welcome ───────────────────────────────────────────────────────
        welcome_status: '┌───□ *WELCOME FEATURE* □\n' +
            '├◇ 📌 *Status:* {status}\n' +
            '├◇ 👥 *Group:* {group}\n' +
