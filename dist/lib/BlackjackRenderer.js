...
exports.renderBlackjackTable = renderBlackjackTable;
...
function shadow(ctx, color, blur, cb) {
    ctx.save();
...
// ─── Hand row ─────────────────────────────────────────────────────────────────
function drawHand(ctx, hand, cx, cy, hideSecond) {
    const CW = 90, gap = 20;
...
// ─── Score pill ───────────────────────────────────────────────────────────────
function drawScore(ctx, cx, cy, score, bust, bj) {
...
// ─── Section label ────────────────────────────────────────────────────────────
function label(ctx, x, y, text, size = 13, color = 'rgba(255,255,255,0.50)') {
    ctx.save();
...
// ─── Main Renderer ────────────────────────────────────────────────────────────
async function renderBlackjackTable(data) {
    ...
    if (['win', 'bust', 'lose', 'push', 'blackjack'].includes(data.status) && data.resultMsg) {
        ...
        const bannerCol = data.status === 'blackjack' ? ['#f39c12', '#c47f17'] :
