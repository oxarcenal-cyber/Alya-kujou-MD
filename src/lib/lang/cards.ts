...
export const cards = {
    en: {
        ...
        sale_already_active:
            '⚠️ *A sale is already active in this group!*\n' +
        ...
        auction_already_active:
            '⚠️ *An auction is already running in this group!*\n' +
        ...
        card_empty_deck_hint:
            '📦 *Your deck is empty!*\n\n' +
            'Cards spawn in groups — use `{p}collect` to claim! 🃏',
        card_empty_coll_hint:
            '🗃️ *Your collection is empty!*\n\n' +
    ...
    hi: {
        card_not_available:
            '🙅 *Abhi koi card available nahi hai!*\n\n' +
        ...
        card_moved_to_deck:
            '✅ *Card Deck Mein Aa Gaya!*\n\n' +
            '{te} *{title}* _(Tier {tier})_\n\n' +
            '📦 *Deck:* {deck}/12\n' +
            '🗃️ *Collection:* {coll} cards',
        card_moved_to_coll:
            '✅ *Card Collection Mein Chala Gaya!*\n\n' +
            '{te} *{title}* _(Tier {tier})_\n\n' +
            '📦 *Deck:* {deck}/12\n' +
            '🗃️ *Collection:* {coll} cards',
        card_swap_done:
        ...
        sale_already_active:
            '⚠️ *Is group mein pehle se ek sale chal rahi hai!*\n' +
        ...
        auction_already_active:
            '⚠️ *Is group mein pehle se ek auction chal raha hai!*\n' +
        ...
        auction_low_bid:
            '❗ *Bid current bid se zyada honi chahiye!*\n\n' +
            '💰 *Current bid:* {current} gold\n' +
            '_Isse zyada lagao!_',
        auction_no_gold:
            '💸 *Itne gold nahi hain!*\n' +
