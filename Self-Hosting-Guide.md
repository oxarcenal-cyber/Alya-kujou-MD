...
### ⛵ Prerequisites
 ...
 ```SH
> git clone https://github.com/REDZEOX/Rias-Gremory
> cd Rias-Gremory
 ```
 ...
 - A cluster URI of the [MongoDB](https://www.mongodb.com/). You can get it by following the steps given [here](https://github.com/REDZEOX/Rias-Gremory/blob/master/MongoDB-Guide.md)
 ...
 [Set it up on Heroku](https://github.com/REDZEOX/Rias-Gremory/blob/master/Heroku-Hosting-Guide.md)
